...
def testPolinomialMethod():
    ...
    for name, matriz in test.items(): # iteramos sobre el diccionario con su respectiva clave y valor.
        ...
        print(f"La matriz {name} tiene el siguiente valor propio: {polynomial_met.Newton_method(matriz,valor_inicial)} correspondiente al valor inicial {valor_inicial} ")
        valor_inicial += 1

if __name__ == "__main__":
    testPolinomialMethod()